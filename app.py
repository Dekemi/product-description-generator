...
try:
    ...
    api_key = st.secrets["AIzaSyCgJAGaM_Bj0fruUbM2oB6suJa9DLlfeWw"]
    ...
    api_key = os.environ.get("AIzaSyCgJAGaM_Bj0fruUbM2oB6suJa9DLlfeWw")
...
def get_gemini_response_with_image(prompt, image):
    """
    Generates a response from the Gemini Pro Vision model using both text and an image.
    """
...
def get_gemini_response_text_only(prompt):
    """
    Generates a response from the Gemini Pro model using only text.
    """
